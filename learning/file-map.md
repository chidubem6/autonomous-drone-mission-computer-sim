...
- src/drone.c — known (2026-09-15) — the engine itself: holds one DroneState, advances it one time-slice at a time with tick(), loops forever in main() at 20 Hz, and renders each state as one telemetry line → [[pointers]], [[printf-format]], [[simulation-tick]], [[delta-time]], [[named-constants]], [[main-loop]], [[sleep-and-timing]], [[fixed-timestep]], [[battery-model]], [[clamping]], [[conditionals]], [[implicit-state]], [[arrays-of-structs]], [[waypoint-list]], [[for-loop]], [[array-length-is-not-stored]]; since 2026-09-16 it also holds the mission — an array of three Waypoints announced at startup before the flight loop begins
